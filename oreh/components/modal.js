...
export const ModalWindow = ({
  ...
  return (
    <Modal
      ...
      modalStyle={
        (isHint && styles.hintModalBox) ||
        (isPop && styles.popModalBox) ||
        styles.wrongAnsModalBox
      }
    >
      <View
        style={
      ...
      >
        {hintNum == 1 ? (
          <>
            {img5 ? (
              ...
              >
                ...
                >
                  <Image
                    style={[styles.hintImage, { width: 50, height: 50 }]}
                    source={img5}
                  />
                  {text && (
                    <Text
              ...
              <View style={{ alignSelf: 'center' }}>
                ...
                {isPop && (
                  <Text
                    style={[styles.popText, { fontSize: 15, marginTop: 15 }]}
                  >
                    {
                      '해당 글자를 미션지에 기입하여,\n‘최종 비밀 지령’을 맞추시오.'
                    }
          ...
          <View style={{ alignSelf: 'center' }}>
            {text2 && (
              <Text style={isHint ? styles.hintText : styles.modalText}>
                {text2}
              </Text>
            )}
            {img2 && (
