    ...
    >
      ...
      >
        <View style={styles.container}>
          ...
          >
            <Text style={styles.basicText}>{STRING.date20}</Text>
          ...
          <ModalWindow
            open={hintOpen}
            setOpen={setHintOpen}
            text={STRING.hint20_1}
            text2={STRING.hint20_2}
            isHint={true}
          />
          <ModalWindow
            open={isHintFin}
